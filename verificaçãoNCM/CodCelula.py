...
# Função para ler os NCMs do arquivo Excel de uma coluna específica
def ler_arquivo_excel(caminho_arquivo, coluna):
    df = pd.read_excel(caminho_arquivo)
    return df[coluna].dropna().tolist()  # .dropna() para ignorar células vazias

# Caminho do arquivo Excel
caminho_arquivo = 'seu_arquivo.xlsx'

# Ler os NCMs da coluna 'A' do arquivo Excel
ncms = ler_arquivo_excel(caminho_arquivo, 'A')
...
driver.find_element(By.LINK_TEXT, "Federal").click()
